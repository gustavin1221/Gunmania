...
namespace GunMania
{
    ...
    class Biter : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Biter", "dogdog");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:biter", "gunmania:biter");
            gun.gameObject.AddComponent<Biter>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Woof");
            gun.SetLongDescription("The hunter's dog's bestfriend\n\n\n" +
                "-Gunmania-");
            ...
            gun.SetupSprite(null, "dogdog_idle_001", 8);
            ...
            gun.barrelOffset.transform.localPosition = new Vector3(0.75f, 0.625f, 0f);
            ...
            projectile.SetProjectileSpriteRight("dogdog_projectile_001", 16, 8, false, tk2dBaseSprite.Anchor.MiddleCenter, 16, 16);
